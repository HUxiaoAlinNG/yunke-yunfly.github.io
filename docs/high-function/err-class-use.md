...
```typescript
import { BadRequestError } from '@yunke/yunfly'
...
```typescript
import { RpcError } from '@yunke/errors'
...
![](https://yunke-oss.oss-cn-hangzhou.aliyuncs.com/bff-basis-fe-sites/imgs/2021/09/17/1631849556581-0-image.png)

所以针对这两个类做了特殊处理，将他们的第一个参数的 message 属性当做 messageDetail，并且提供了第二个参数作为 message，如果没传，则默认为 “服务器异常，请重试”，具体使用方式如下：

```javascript
import { RpcError, InternalServerError } from '@yunke/errors'
